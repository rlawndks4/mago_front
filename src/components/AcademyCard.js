...
const AcademyCard = (props) => {
    ...
    return (
        <>
            <AcademyContainer style={{margin:`${idx%2==0?'0 auto 16px 0':'0 0 16px auto'}` }}>
                <AcademyImg src={backUrl + item?.main_img}/>
                <AcademyTextContainer>
                <div style={{margin:'0 0 auto 0',color:theme.color.blue,fontSize:theme.size.font4}}>{item.user_nickname}</div>
